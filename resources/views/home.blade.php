...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <header class="header" id="home">
        <div class="container">
            <div class="infos">
                ...
                <h6 class="title">Apurba</h6>
                <p>Designer Protfolio</p>
        ...
        <div class="container mt-5">
            <div class="row text-center text-md-left">
                ...
                <div class="pl-md-4 col-md-9">
                    <h6 class="title">Apurba</h6>
                    <p class="subtitle">Protfolio Designer</p>
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Beatae modi dolor iure fuga nihil, vel ab quaerat aspernatur iste odio repellendus odit vero velit quibusdam et nemo consequuntur ipsum nisi!</p>
    ...
    <footer class="page-footer">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    {{-- <p>Copyright <script>document.write(new Date().getFullYear())</script> &copy; <a href="http://www.devcrud.com" target="_blank">Apurba</a></p> --}}
                    <p>Copyright &copy; <a href="#">Apurba</a></p>
                </div>
                <div class="col-sm-6">
                    <div class="socials">
                        <a class="social-item" href="javascript:void(0)"><i class="ti-facebook"></i></a>
